const NICHES = {
  gym: {
    ...
    instagramHashtags: ['homegym', 'fitnessgear', 'workoutmotivation', 'gymlife'],
    products: [
  ...
  anxiety: {
    ...
    instagramHashtags: ['selfcare', 'anxietyrelief', 'wellness', 'mentalhealth'],
    products: [
  ...
  home: {
    ...
    instagramHashtags: ['kitchengadgets', 'homeorganization', 'cookinghacks', 'homedecor'],
    products: [
  ...
  pet: {
    ...
    instagramHashtags: ['dogsofinstagram', 'catsofinstagram', 'petlife', 'petproducts'],
    products: [
  ...
  tech: {
    ...
    instagramHashtags: ['techgadgets', 'smarthome', 'gadgetlover', 'techlife'],
    products: [],
  },
  beauty: {
    ...
    instagramHashtags: ['skincare', 'beautytools', 'glowup', 'skincareRoutine'],
    products: [],
  },
  outdoor: {
    label: 'Outdoor & camping',
    redditSubs: ['CampingGear', 'Ultralight', 'hiking', 'camping'],
    keywords: ['camping gear', 'hiking accessory', 'survival tool', 'outdoor gadget'],
    instagramHashtags: ['campinglife', 'hikingadventures', 'outdoorgear', 'traillife'],
    products: [],
  },
  fashion: {
    label: 'Fashion & accessories',
    redditSubs: ['streetwear', 'frugalmalefashion', 'femalefashionadvice', 'Sneakers'],
    keywords: ['fashion accessory', 'streetwear', 'jewelry', 'sunglasses'],
    instagramHashtags: ['streetstyle', 'fashionfinds', 'ootd', 'accessories'],
    products: [],
  },
  gaming: {
    label: 'Gaming & esports',
    redditSubs: ['gaming', 'pcgaming', 'battlestations', 'MechanicalKeyboards'],
    keywords: ['gaming accessory', 'mechanical keyboard', 'gaming desk', 'RGB lighting'],
    instagramHashtags: ['gamingsetup', 'pcgaming', 'gaminglife', 'mechanicalkeyboard'],
    products: [],
  },
  baby: {
    label: 'Baby & kids',
    redditSubs: ['BabyBumps', 'Parenting', 'Mommit', 'daddit'],
    keywords: ['baby product', 'kids toy', 'baby safety', 'nursery decor'],
    instagramHashtags: ['babygear', 'momlife', 'newborn', 'toddlerlife'],
    products: [],
  },
  automotive: {
    label: 'Automotive',
    redditSubs: ['cars', 'Cartalk', 'AutoDetailing', 'Autos'],
    keywords: ['car accessory', 'auto detailing', 'car gadget', 'car organizer'],
    instagramHashtags: ['cardetailing', 'cargadgets', 'autolife', 'caraccessories'],
    products: [],
  },
};
